...
| [Recurring Bills](https://testflight.apple.com/join/UEpGwZnh) · [source](https://github.com/kumar-gautam24/honest-ledger) | Flutter · Riverpod · Drift · FastAPI · AWS EC2 | TestFlight beta, in App Store review · real No-Cost-EMI cost engine · provider-agnostic LLM layer · CI/CD to EC2 via GitHub Actions |
...
- **Payments** — FastAPI payment microservice with HMAC-SHA256 Razorpay webhook verification and atomic SQL credit deduction
- **Security** — hardened against SOC audit: SSL pinning, root/jailbreak detection, OAuth injection fix
...
<table>
  <tr>
    <td width="50%" valign="top"><img alt="Contribution activity" src="metrics.activity.svg" width="100%"></td>
    <td width="50%" valign="top"><img alt="Language breakdown" src="metrics.languages.svg" width="100%"></td>
  </tr>
</table>
...
[Portfolio & Blog](https://portfolio-mu-ebon-q5pfh9kz74.vercel.app) &nbsp;·&nbsp; [LinkedIn](https://linkedin.com/in/gautam-kumar-24feb) &nbsp;·&nbsp; [X](https://x.com/kumar_gautam24)
